...
MThree.Loader = function( showStatus ) {
...
MThree.Loader.prototype = {
	...
	// Load models generated by Blender exporter and original OBJ converter (converter_obj_MThree.py)
	...
	// Load models generated by slim OBJ converter with ASCII option (converter_obj_MThree_slim.py -t ascii)
	...
	loadAscii: function ( url, callback, urlbase ) {
		...
		worker.onmessage = function( event ) {
			...
			MThree.Loader.prototype.createModel( event.data, callback, urlbase );
	...
	// Load models generated by slim OBJ converter with BINARY option (converter_obj_MThree_slim.py -t binary)
	...
	loadBinary: function( url, callback, urlbase ) {
		...
		var s = (new Date).getTime(),
			worker = new Worker( url ),
			callback_progress = this.showProgress ? MThree.Loader.prototype.updateProgress : null;
		...
		worker.onmessage = function( event ) {
			...
			MThree.Loader.prototype.loadAjaxBuffers( buffers, materials, callback, urlbase, callback_progress );
		...
		xhr.onreadystatechange = function() {
			...
			if ( xhr.readyState == 4 ) {
				...
				if ( xhr.status == 200 || xhr.status == 0 ) {
					...
					MThree.Loader.prototype.createBinModel( xhr.responseText, callback, urlbase, materials );
	...
	createBinModel: function ( data, callback, urlbase, materials ) {
		...
		var Model = function ( urlbase ) {
			...
			MThree.Geometry.call(this);

			MThree.Loader.prototype.init_materials( scope, materials, urlbase );
			...
			function init_vertices( start ) {
				...
				for( i = start; i < end; i += stride ) {
					...
					MThree.Loader.prototype.v( scope, x, y, z );
			...
			function add_tri( i ) {
				...
				MThree.Loader.prototype.f3( scope, a, b, c, m );
			...
			function add_tri_n( i ) {
				...
				MThree.Loader.prototype.f3n( scope, normals, a, b, c, m, na, nb, nc );
			...
			function add_quad( i ) {
				...
				MThree.Loader.prototype.f4( scope, a, b, c, d, m );
			...
			function add_quad_n( i ) {
				...
				MThree.Loader.prototype.f4n( scope, normals, a, b, c, d, m, na, nb, nc, nd );
			...
			function add_uv3( i ) {
				...
				MThree.Loader.prototype.uv3( scope, u1, v1, u2, v2, u3, v3 );
			...
			function add_uv4( i ) {
				...
				MThree.Loader.prototype.uv4( scope, u1, v1, u2, v2, u3, v3, u4, v4 );
		...
		Model.prototype = new MThree.Geometry();
	...
	createModel: function ( data, callback, urlbase ) {
		...
		var Model = function ( urlbase ) {
			...
			MThree.Loader.prototype.init_materials( scope, data.materials, urlbase );
			...
			function init_faces() {
				...
				function add_tri_n( src, i ) {
					...
					MThree.Loader.prototype.f3n( scope, data.normals, a, b, c, m, na, nb, nc );
				...
				function add_quad_n( src, i ) {
					...
					MThree.Loader.prototype.f4n( scope, data.normals, a, b, c, d, m, na, nb, nc, nd );
	...
	v: function( scope, x, y, z ) {
		...
		scope.vertices.push( new MThree.Vertex( new MThree.Vector3( x, y, z ) ) );
	...
	f3: function( scope, a, b, c, mi ) {
		...
		scope.faces.push( new MThree.Face3( a, b, c, null, material ) );
	...
	f4: function( scope, a, b, c, d, mi ) {
		...
		var material = scope.materials[ mi ];
		scope.faces.push( new MThree.Face4( a, b, c, d, null, material ) );
	...
	f3n: function( scope, normals, a, b, c, mi, na, nb, nc ) {
		...
		scope.faces.push( new MThree.Face3( a, b, c, 
						  [new MThree.Vector3( nax, nay, naz ), 
						   new MThree.Vector3( nbx, nby, nbz ), 
						   new MThree.Vector3( ncx, ncy, ncz )], 
						  material ) );
	...
	f4n: function( scope, normals, a, b, c, d, mi, na, nb, nc, nd ) {
		...
		scope.faces.push( new MThree.Face4( a, b, c, d,
						  [new MThree.Vector3( nax, nay, naz ), 
						   new MThree.Vector3( nbx, nby, nbz ), 
						   new MThree.Vector3( ncx, ncy, ncz ), 
						   new MThree.Vector3( ndx, ndy, ndz )], 
						  material ) );
	...
	uv3: function( scope, u1, v1, u2, v2, u3, v3 ) {
		...
		var uv = [];
		uv.push( new MThree.UV( u1, v1 ) );
		uv.push( new MThree.UV( u2, v2 ) );
		uv.push( new MThree.UV( u3, v3 ) );
		scope.uvs.push( uv );
	...
	init_materials: function( scope, materials, urlbase ) {
		...
		for ( var i = 0; i < materials.length; ++i ) {
			...
			scope.materials[i] = [ MThree.Loader.prototype.createMaterial( materials[i], urlbase ) ];
	...
	createMaterial: function ( m, urlbase ) {
		...
		if ( m.map_diffuse && urlbase ) {
			...
			material = new MThree.MeshLambertMaterial( { map: new MThree.Texture( texture ) } );
			...
			material = new MThree.MeshLambertMaterial( { color: color, opacity: m.transparency } );

		} else if ( m.a_dbg_color ) {

			material = new MThree.MeshLambertMaterial( { color: m.a_dbg_color } );

		} else {

			material = new MThree.MeshLambertMaterial( { color: 0xeeeeee } );
