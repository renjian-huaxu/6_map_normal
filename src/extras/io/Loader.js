...
const Loader = function( showStatus ) {
...
Loader.prototype = {
	...
	// Load models generated by Blender exporter and original OBJ converter (converter_obj_py)
	...
	loadAscii: function ( url, callback, urlbase ) {
		...
		worker.onmessage = function( event ) {
			...
			Loader.prototype.createModel( event.data, callback, urlbase );
	...
	loadBinary: function( url, callback, urlbase ) {
		...
		var s = (new Date).getTime(),
			worker = new Worker( url ),
			callback_progress = this.showProgress ? Loader.prototype.updateProgress : null;
		...
		worker.onmessage = function( event ) {
			...
			Loader.prototype.loadAjaxBuffers( buffers, materials, callback, urlbase, callback_progress );
		...
		xhr.onreadystatechange = function() {
			...
			if ( xhr.readyState == 4 ) {
				...
				if ( xhr.status == 200 || xhr.status == 0 ) {
					...
					Loader.prototype.createBinModel( xhr.responseText, callback, urlbase, materials );
	...
	createBinModel: function ( data, callback, urlbase, materials ) {
		...
		var Model = function ( urlbase ) {
			...
			Loader.prototype.init_materials( scope, materials, urlbase );
			...
			function init_vertices( start ) {
				...
				for( i = start; i < end; i += stride ) {
					...
					Loader.prototype.v( scope, x, y, z );
			...
			function add_tri( i ) {
				...
				Loader.prototype.f3( scope, a, b, c, m );
			...
			function add_tri_n( i ) {
				...
				Loader.prototype.f3n( scope, normals, a, b, c, m, na, nb, nc );
			...
			function add_quad( i ) {
				...
				Loader.prototype.f4( scope, a, b, c, d, m );
			...
			function add_quad_n( i ) {
				...
				Loader.prototype.f4n( scope, normals, a, b, c, d, m, na, nb, nc, nd );
			...
			function add_uv3( i ) {
				...
				Loader.prototype.uv3( scope, u1, v1, u2, v2, u3, v3 );
			...
			function add_uv4( i ) {
				...
				Loader.prototype.uv4( scope, u1, v1, u2, v2, u3, v3, u4, v4 );
	...
	createModel: function ( data, callback, urlbase ) {
		...
		var Model = function ( urlbase ) {
			...
			Loader.prototype.init_materials( scope, data.materials, urlbase );
			...
			function init_faces() {
				...
				function add_tri_n( src, i ) {
					...
					Loader.prototype.f3n( scope, data.normals, a, b, c, m, na, nb, nc );
				...
				function add_quad_n( src, i ) {
					...
					Loader.prototype.f4n( scope, data.normals, a, b, c, d, m, na, nb, nc, nd );
	...
	f3: function( scope, a, b, c, mi ) {
		...
		scope.faces.push( new Face3( a, b, c, null, material ) );
	...
	f4: function( scope, a, b, c, d, mi ) {
		...
		var material = scope.materials[ mi ];
		scope.faces.push( new Face4( a, b, c, d, null, material ) );
	...
	init_materials: function( scope, materials, urlbase ) {
		...
		for ( var i = 0; i < materials.length; ++i ) {
			...
			scope.materials[i] = [ Loader.prototype.createMaterial( materials[i], urlbase ) ];
	...
	createMaterial: function ( m, urlbase ) {
		...
		if ( m.map_diffuse && urlbase ) {
			...
			material = new MeshLambertMaterial( { map: new Texture( texture ) } );
			...
			material = new MeshLambertMaterial( { color: color, opacity: m.transparency } );

		} else if ( m.a_dbg_color ) {

			material = new MeshLambertMaterial( { color: m.a_dbg_color } );

		} else {

			material = new MeshLambertMaterial( { color: 0xeeeeee } );
