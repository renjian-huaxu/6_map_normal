var ShaderUtils = {
	...
	lib: { 'fresnel': {
		...
		'normal' : {
			...
			"uPointLightPos": { type: "v3", value: new MThree.Vector3() },
			"uPointLightColor": { type: "c", value: new MThree.Color( 0xeeeeee ) },

			"uDirLightPos":	{ type: "v3", value: new MThree.Vector3() },
			"uDirLightColor": { type: "c", value: new MThree.Color( 0xeeeeee ) },

			"uAmbientLightColor": { type: "c", value: new MThree.Color( 0x050505 ) },

			"uDiffuseColor": { type: "c", value: new MThree.Color( 0xeeeeee ) },
			"uSpecularColor": { type: "c", value: new MThree.Color( 0x111111 ) },
			"uAmbientLightColor": { type: "c", value: new MThree.Color( 0x050505 ) },
